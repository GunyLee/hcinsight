...
export const theme = createTheme({
  palette: {
    ...
    action: {
      active: alpha(blueGrey[800], 0.54),
      hover: alpha(blueGrey[800], 0.04),
      selected: alpha(blueGrey[800], 0.08),
      disabled: alpha(blueGrey[800], 0.26),
      disabledBackground: alpha(blueGrey[800], 0.12),
      focus: alpha(blueGrey[800], 0.12),
    },
  },
  shape: {
    borderRadius: 8,
  ...
  typography: {
    ...
    fontFamily: `'Noto Sans KR', 'Pretendard', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif`,
